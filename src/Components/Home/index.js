        ...
        <div className="zwallet_color rounded-14 p-4">
          <div className="d-flex justify-content-between">
            <div>
              ...
              <h1 className="text-white my-3">Rp{this.props.data.balance}</h1>
              <div className="font_softGrey">+{this.props.data.phoneNumber}</div>
            </div>
          ...
          <div className="col-lg-5">
            <div className="bg-white rounded-14 p-4 shadow_box">
              <div className="d-flex align-items-center justify-content-between">
                ...
                <Link className="small text-primary" to={{pathname:`/transaction/${this.props.data.id}`}}>
                  See All
                </Link>
              </div>
              <div className="d-flex justify-content-between align-items-center py-3">
                <div className="d-flex">
                  <img
                    height="56px"
                    width="56px"
                    src="assets/Img/samuel-suhi.svg"
                    alt=""
                  />
              ...
              <div className="d-flex justify-content-between align-items-center py-3">
                <div className="d-flex">
                  <img
                    height="56px"
                    width="56px"
                    src="assets/Img/Christine-Mar....svg"
                    alt=""
                  />
